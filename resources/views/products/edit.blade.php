...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('shop.product.edit_title', ['product_name' => $product->name]) }}</div>
                        ...
                        <div class="row mb-3 justify-content-center">
                            ...
                            <div class="col-md-6">
                                @if (!is_null($product->image_path))
                                    <img class="img-thumbnail" src="{{ asset('storage/'.$product->image_path) }}" alt="Zdjęcie produktu">
                                @endif
                            </div>
                        </div>
